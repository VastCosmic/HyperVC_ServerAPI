...
import os
# PY_PROJECT_ROOT = os.path.dirname(os.getcwd())   #获取PY项目根目录
# PROJECT_ROOT=PY_PROJECT_ROOT[:-12] #获取项目根目录
# print(PROJECT_ROOT)
...
MAT_UPLOAD_PATH = "Models\MatUploadFile\PaviaU_gt.mat"
MAT_PATH = "Models\MatSouce\PaviaU_gt.mat"
MAT_CORRECTED_PATH = "Models\MatSouce\PaviaU.mat"
MAT_KEY = "paviaU_gt"
MAT_CORRECTED_KEY = "paviaU"

NET_PATH = "Models\Model_NET\model_PaviaU_net.pth"
print(NET_PATH)
CLASSIFICATION_REPORT_PATH = "Result\classification_report_" + TASK_UUID + ".txt"

IMG_NAME = "PaviaU_Output_" + TASK_UUID + ".png"
UPLOAD_IMG_PATH = "Result\PaviaU_Output_" + TASK_UUID + ".png"
