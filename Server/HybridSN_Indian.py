def process_HybridSN_Indian(TASK_UUID):
    ...
    #读取配置文件
    import yaml
    yamlPath = PROJECT_ROOT+"Config\HyperVC_Setting.yaml"
    ...
    print(NET_PATH)
    CLASSIFICATION_REPORT_PATH = PROJECT_ROOT+"Result\classification_report_" + TASK_UUID + ".txt"

    IMG_NAME = "Indian_Output_" + TASK_UUID + ".png"
    UPLOAD_IMG_PATH = PROJECT_ROOT+"Result\Indian_Output_" + TASK_UUID + ".png"
